	...
	<script>
		...
		function checkValideRow(cnt){
			if(!$("#collage_name_"+cnt).length == 0){
				...
				var university_inititute = $('#university_inititute_' +cnt).val();
				...
				var percantage = $('#percantage_'+cnt).val();
					...
					if (university_inititute == null || university_inititute.length == 0) {
						alert("University is mandatory");
						$('#university_inititute_'+cnt).focus();
						return false;
					}
